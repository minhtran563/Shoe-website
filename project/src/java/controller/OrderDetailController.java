...
public class OrderDetailController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (acc == null || (!"EMPLOYEE".equals(acc.getRole()) && !"ADMIN".equals(acc.getRole()))) {
        ...
        try {
            ...
            if (idRaw != null) {
                ...
                // Lấy danh sách đã bao gồm tên sản phẩm, màu, size nhờ SQL JOIN trong DAO
                request.setAttribute("orderDetails", dao.getOrderDetailsByOrderID(orderID));
                request.setAttribute("orderID", orderID);
            }
        } catch (NumberFormatException e) {
            // Xử lý khi orderID không hợp lệ (ví dụ: quay lại trang lịch sử)
